            ...
            {webinars.map((w, i) => (
              ...
              >
                ...
                <div className="flex-shrink-0 w-full sm:w-auto">
                  <a
                    href={w.id === 2 || w.id === 3 ? "https://course.rosmededucation.ru/question" : "#register"}
                    target={w.id === 2 || w.id === 3 ? "_blank" : undefined}
                    rel={w.id === 2 || w.id === 3 ? "noopener noreferrer" : undefined}
