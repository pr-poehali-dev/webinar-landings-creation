            ...
            {webinars.map((w, i) => (
              ...
              >
                ...
                <div className="flex-shrink-0 w-full sm:w-auto">
                  <a
                    href={w.id === 1 ? "https://rutube.ru/video/fb1bc15ea528f93f8dd65e8db0bc8f01/" : w.id === 3 ? "https://course.rosmededucation.ru/question" : "#register"}
                    target={w.id === 1 || w.id === 3 ? "_blank" : undefined}
                    rel={w.id === 1 || w.id === 3 ? "noopener noreferrer" : undefined}
